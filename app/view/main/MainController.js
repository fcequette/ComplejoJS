...
Ext.define('Torneo.view.main.MainController', {
    ...
    onafterRender:function(panel,e){
      /*  Ext.create('Ext.window.Window', {
             ...
             onEsc: Ext.emptyFn(),
             closable: false,
             bodyStyle: 'border-color:black;background:url("http://grupobinario.sytes.net/fondo_sampaoli.jpg") no-repeat;padding:10px;background-color: black;background-size:100%;background-position: center; ',
             resizable:false
             ,xtype: 'form'
             ,itemId:'winLogin'
             ,header:{
                 style: 'background-color:black;border-color:black;padding:10px'
                 ,title: '<img src="http://grupobinario.sytes.net/logo_sampaoli.png" border="0" width="200" height="80">'
             }
              ,layout: 'border'
              ,items:[{
                    xtype:'container'
